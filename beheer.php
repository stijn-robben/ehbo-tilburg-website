    ...
    <body class="bg-light">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <li class="nav-item dropdown nav-link">
                            <a
                                href="#"
                                class="nav-link dropdown-toggle text-secondary text-nav navbar-dropdown"
        ...
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 container">
            <div class="col-md-4 d-flex align-items-center mb-3 me-2 mb-md-0 lh-1">
                <a class="navbar-brand" href="#" aria-label="Back to the top of the page"
                    ><img src="./img/logo.png" width="50" height="auto" alt="Logo van EHBO Tilburg"
                /></a>
            </div>

            <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
                <li class="ms-3">
                    <a class="text-muted" href="#" aria-label="Link to our instagram page"
                        ><svg
                ...
                <li class="ms-3">
                    <a class="text-muted" href="#" aria-label="Link to our twitter page"
                        ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="30"
                            height="30"
                ...
                <li class="ms-3">
                    <a class="text-muted" href="#" aria-label="Link to our facebook page"
                        ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="30"
                            height="30"

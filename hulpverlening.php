...
$queryPart1 = "SELECT * FROM content WHERE page = 'hulpverlening' AND part = 1";
$resultPart1 = mysqli_query($conn, $queryPart1);

$queryPart2 = "SELECT * FROM content WHERE page = 'hulpverlening' AND part = 2";
$resultPart2 = mysqli_query($conn, $queryPart2);

$queryPart3 = "SELECT * FROM content WHERE page = 'hulpverlening' AND part = 3";
